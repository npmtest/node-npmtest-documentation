...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-documentation/node_modules/documentation/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-documentation/node_modules/documentation/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-documentation/node_modules/documentation/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  var elements = arguments;</span>
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function (comment) {</span></span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0; comment &amp;&amp; i &lt; elements.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >      comment = elements[i](comment);</span>
    }
 ...
 * @private
 */
<span class="fstat-no" title="function not covered" >function noop(comment) {</span>
<span class="cstat-no" title="statement not covered" >  return comment;</span>
}
&nbsp;
/**
 ...
 */
module.exports = <span class="fstat-no" title="function not covered" >function (indexes, options, callback) {</span>
<span class="cstat-no" title="statement not covered" >  options = options || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (typeof indexes === 'string') {</span>
<span class="cstat-no" title="statement not covered" >    indexes = [indexes];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var inputFn = (options.polyglot || options.shallow) ? shallow : dependency;</span>
<span class="cstat-no" title="statement not covered" >  var parseFn = (options.polyglot) ? polyglot : parseJavaScript;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return inputFn(indexes, options, <span class="fstat-no" title="function not covered" >function (error, inputs) {</span></span>
...
<span class="cstat-no" title="statement not covered" >      callback(null,</span>
        filterAccess(
          ...
          hierarchy(
            inputs
              .filter(filterJS)
              .reduce(<span class="fstat-no" title="function not covered" >function (memo, file) {</span>
<span class="cstat-no" title="statement not covered" >                return memo.concat(parseFn(file));</span>
              }, [])
              .map(pipeline(
                lint.lint,
                inferName(),
