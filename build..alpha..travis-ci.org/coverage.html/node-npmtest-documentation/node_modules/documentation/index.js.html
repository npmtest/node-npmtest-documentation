...
function pipeline() {
  ...
  return <span class="fstat-no" title="function not covered" >function (comment) {</span>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof indexes === 'string') {
<span class="cstat-no" title="statement not covered" >    indexes = [indexes];</span>
  }
&nbsp;
  var inputFn = (options.polyglot || options.shallow) ? <span class="branch-0 cbranch-no" title="branch not covered" >shallow </span>: dependency;
  var parseFn = (options.polyglot) ? <span class="branch-0 cbranch-no" title="branch not covered" >polyglot </span>: parseJavaScript;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return callback(error);</span>
    ...
    try {
      callback(null,
        filterAccess(
          (options.private || options.lint) ? <span class="branch-0 cbranch-no" title="branch not covered" >[] </span>: undefined,
          hierarchy(
            inputs
              .filter(filterJS)
              ...
              .map(pipeline(
                ...
                inferMembership(),
                nest,
                options.github ? <span class="branch-0 cbranch-no" title="branch not covered" >github </span>: noop
              ))
              .filter(Boolean)
